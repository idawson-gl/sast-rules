...
class CipherCommon { // Detects: CIPHER_INTEGRITY, PADDING_ORACLE
  ...
  def noIntegrityAndOraclePaddingAttack(key: Nothing, plainText: Array[Byte]): Unit = {
  ...
  @throws[BadPaddingException]
  @throws[InvalidKeyException]
  def noIntegrity(key: Nothing, plainText: Array[Byte]): Unit = {
  ...
  @throws[BadPaddingException]
  @throws[InvalidKeyException]
  def noIntegrityAndDESUsage(key: Nothing, plainText: Array[Byte]): Unit = {
  ...
  @throws[BadPaddingException]
  @throws[InvalidKeyException]
  def noIntegrityAndDESedeUsage(key: Nothing, plainText: Array[Byte]): Unit = {
